...
function resolvePlexItem($server, $token, $item, $nowPlaying = false, $showNames = false, $role = false, $playlist = false) {
    ...
    // Assemble Item And Cache Into Array
    if($nowPlaying){
		$musicOverlay = ($widthOverride == 56) ? '<img class="" style="width: 56%;display:block;position: absolute;top: 1px;left:5px;overflow: hidden;filter: blur(2px) grayscale(1);padding-bottom: 2px;" src="'.$image_url.'">
		<img class="" style="width: 56%;display:block;position: absolute;top: 1px;right:5px;overflow: hidden;filter: blur(2px) grayscale(1);padding-bottom: 2px;" src="'.$image_url.'">' : '';
