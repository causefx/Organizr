...
<head>
  ...
  table.fc-list-table {
                                  ...
                                  <body id="body-homepage" class="scroller-body group-<?php echo $group;?>" style="padding: 0px;">
                                    <div class="main-wrapper" style="position: initial;">
                                      <div id="content" class="container-fluid">
                                        ...
                                        <?php if (qualifyUser(HOMEPAGENOTICEAUTH) && HOMEPAGENOTICETITLE && HOMEPAGENOTICETYPE && HOMEPAGENOTICEMESSAGE && HOMEPAGENOTICELAYOUT) {
    echo buildHomepageNotice(HOMEPAGENOTICELAYOUT, HOMEPAGENOTICETYPE, HOMEPAGENOTICETITLE, HOMEPAGENOTICEMESSAGE);
} ?>
    ...
    ?>
        ...
        echo "<div>" . HOMEPAGECUSTOMHTML1 . "</div>";
    } ?>
                                              ...
                                              <div class="content-box">
                                                <div class="tabbable panel with-nav-tabs panel-default">
                                                  <div class="panel-heading">
                                                    ...
                                                    <h3 class="pull-left"><?php if (NZBGETURL != "") {
            echo "NZBGet ";
        }
        if (SABNZBDURL != "") {
            echo "SABnzbd ";
        ...
        ?>
                                          <div id="plexRowNowPlaying" class="row">
                                            <?php if (PLEXPLAYINGNOW == "true") {
            echo getPlexStreams(12, PLEXSHOWNAMES, $USER->role);
        } ?>
                                          </div>
        ...
        ?>
                                          <div id="embyRowNowPlaying" class="row">
                                            <?php if (EMBYPLAYINGNOW == "true") {
            echo getEmbyStreams(12, EMBYSHOWNAMES, $USER->role);
        } ?>
                                          </div>
                                              ...
                                              <div class="form-group pull-right">
                                                ...
                                                <div class="btn-group" role="group">
                                                  ...
                                                  <ul style="right:0; left: auto" class="dropdown-menu">
                                                    ...
                                                    <?php if (RADARRURL != "") {
            echo '<li><a class="calendarOption" calendarOption="film" href="javascript:void(0)">Movies</a></li>';
        } ?>
                                                      <?php if (SONARRURL != "") {
            echo '<li><a class="calendarOption" calendarOption="tv" href="javascript:void(0)">TV Shows</a></li>';
        } ?>
                                                        <?php if (HEADPHONESURL != "") {
            echo '<li><a class="calendarOption" calendarOption="music" href="javascript:void(0)">Music</a></li>';
        } ?>
                                                        </ul>
                                                      </div>
                                                    </div>
        ...
        ?>
                                              ...
                                              var queueLoad = function() {
                                                <?php if (SABNZBDURL != "") {
            echo '$("tbody.dl-queue.sabnzbd").load("ajax.php?a=sabnzbd-update&list=queue");';
        } ?>
                                                <?php if (NZBGETURL != "") {
            echo '$("tbody.dl-queue.nzbget").load("ajax.php?a=nzbget-update&list=listgroups");';
        } ?>
                                              };

                                              var historyLoad = function() {
                                                <?php if (SABNZBDURL != "") {
            echo '$("tbody.dl-history.sabnzbd").load("ajax.php?a=sabnzbd-update&list=history");';
        } ?>
                                                <?php if (NZBGETURL != "") {
            echo '$("tbody.dl-history.nzbget").load("ajax.php?a=nzbget-update&list=history");';
        } ?>
                                              };
