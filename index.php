...
if (!file_exists('config/config.php')) {
    if ($action == "createLocation") {
        if (isset($_POST['database_Location'])) {
            ...
            if (substr($_POST['database_Location'], -1) != "/") : $_POST['database_Location'] = $_POST['database_Location'] . "/";
            endif;
...
if (file_exists('config/config.php')) {
    ...
    if (LOADINGICON !== "") : $loadingIcon = LOADINGICON;
    endif;
    if (SLIMBAR == "true") : $slimBar = "30";
    $userSize = "25"; else : $slimBar = "56";
    $userSize = "40";
    endif;
                                                                                                                                    ...
                                                                                                                                    <?php if ($row['iconurl']) {
                                                                                                                                      ...
                                                                                                                                      <i style="font-size: 19px; padding: 0 10px; font-size: 19px;">
                                                                                                                                        ...
                                                                                                                                        <?php if ($row['ping'] == "true" && $row['ping_url']) {
                                                                                                                                              $allPings["image".$name] = $row['ping_url']; ?>
                                                                                                                                      ...
                                                                                                                                      <i class="fa <?=$row['icon']; ?> fa-lg">
                                                                                                                                        <span id="<?=$row['url']; ?>s" class="badge badge-success" style="position: absolute;z-index: 100;right: 0px;"></span>
                                                                                                                                        <?php if ($row['ping'] == "true" && $row['ping_url']) {
                                                                                                                                              $allPings["icon".$name] = $row['ping_url']; ?>
                                                                                                                                          <ping id="ping-<?=$name; ?>"></ping>
                                                                                                                                          <?php
                                                                                                                                          } ?>
                                                                                                                                      </i>
