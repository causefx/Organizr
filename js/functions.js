...
function pingUpdateItem(ping) {
    ...
    organizrAPI2('GET', 'api/v2/ping/' + ping,).success(function (data) {
        ...
        if (activeInfo.user.groupID <= activeInfo.settings.ping.authMs && activeInfo.settings.ping.ms) {
...
function jsFriendlyJSONStringify(s) {
    return JSON.stringify(s).replace('\'', "").replace(/\u2028/g, '\\u2028').replace(/\u2029/g, '\\u2029');
}
