...
function checkDatabase($type, $table, $check)
{
    ...
    $query = 'PRAGMA table_info(' . $table . ')'; elseif ($type == "SELECT") :
    ...
    if (in_array($check, $buildArray)) :
      ...
      $found = '<div class="panel panel-success"><div class="panel-heading"><h3 class="panel-title">'. $check . '</h3></div><div style="color: gray" class="panel-body">' . $check . ' was found in ' . $table . ' and is Good 2 Go!</div></div>'; elseif (!in_array($check, $buildArray)) :
